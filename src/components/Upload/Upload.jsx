...
// import { sendInviteRequest } from '../../actions/actionCreators';
...
export default connect(/*mapStateToProps*/)(withStyles(styles, { withTheme: true })(Upload)); // export default withStyles(styles)(Home);