      ...
      >
        ...
        <DialogContent>
          <span className={classes.paragraph}>
            The first time you signed in, you had granted this app access to
            your Google account. By revoking access, you are resetting those
            granted permissions.
          </span>
          <p className={classes.paragraph}>
            By selecting <span className={classes.mockButton}>revoke</span> you
            will also be immediately signed out.
          </p>
          <p className={classes.paragraph}>
